                    ...
                    <div class="side-one"><!-- side 1 -->
                        <div class="form-group" id="lbl-kode">
                            ...
                            <input type="text" class="form-control" id="kode_barang" name="kode_name"
                                   placeholder="Kode Barang" maxlength="15" value="<?=$data['Kode_Barang'];?>">
                        </div>
                        ...
                        <div class="form-group" id="lbl-nama">
                            ...
                            <input type="text" class="form-control" id="nama_barang" name="nama_barang"
                                   placeholder="Nama Barang" maxlength="150" value="<?=$data['Barang_Name'];?>">
                ...
                <div class="side-two">
                    <div class="form-group" id="lbl-hb">
                        ...
                        <input type="text" class="form-control" id="harga_beli" name="harga_beli"
                               maxlength="20" placeholder="Rp. xxx" onkeyup='cek_hb()' value="<?=$data['Harga_Beli'];?>">
                    ...
                    <div class="form-group" id="lbl-hj">
                        ...
                        <input type="text" class="form-control" id="harga_jual" name="harga_jual"
                               maxlength="20" placeholder="Rp. xxx" onkeyup='cek_hj()' value="<?=$data['Harga_Jual'];?>" >
                    ...
                    <div class="form-group" id="lbl-ukuran">
                        ...
                        <input type="text" class="form-control" id="ukuran" name="ukuran"
                               placeholder="99 x 99" maxlength="15"'  value="<?=$data['Ukuran'];?>">
                    </div>
                    ...
                    <div class="form-group" id="lbl-qty">
                        ...
                        <input type="text" class="form-control" id="qty" name="qty"
                               placeholder="Qty" maxlength="10" onkeypress='validate_number(event)' value="<?=$data['Qty'];?>">
                    ...
                    <div class="form-group" id="lbl-limit">
                        ...
                        <input type="text" class="form-control" id="limit" name="limit"
                               placeholder="limit" maxlength="10" onkeypress='validate_number(event)' value="<?=$data['Limit'];?>">
