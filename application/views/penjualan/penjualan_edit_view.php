...
<div class="content-container" >
 ...
 <div class="form-add-new">
			...
			<div class="box box-primary">
				...
				<h1 class="heading">Edit Penjualan
				...
				<div class="form-group" id="lbl-kode">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control" id="kode_bon" name="kode_bon" 
                            placeholder="Kode BON" maxlength="15" onkeyup='cek_kode()' value="<?=$data_penjualan[0]['Kode_Bon'];?>"/>  
				...
				<div class="form-group" id="lbl-customer"> 
					...
					<div class="col-sm-6"> 
						<input type="text" class="form-control" id="nama_customer" name="nama_customer" 
                            placeholder="Nama Pembeli" maxlength="150" onkeyup='cek_nama()' value="<?=$data_penjualan[0]['Nama_Pembeli'];?>" />
               	...
               	<div class="form-group" id="lbl-tgl-beli"> 
					...
					<div class="col-sm-6"> 
						<input type="text" class="form-control" id="tgl_penjualan" name="tgl_penjualan" 
                            placeholder="MM/dd/YYYY" maxlength="150" onkeyup='cek_nama()' value="<?=$data_penjualan[0]['Tgl_Penjualan'];?>">
					</div><span id='err_nama' class="err_span"></span>
				</div>
                ...
                <div class="side-two"><!-- side 2 -->
                    <div class="form-group">
                          ...
                          <select class="form-control status" id="stat" name="stat">
                            <option value="1" <?php if($data_penjualan[0]['Status'] == 1) echo "selected='selected'";?>>CASH</option>
                            <option value="2" <?php if($data_penjualan[0]['Status'] == 2) echo "selected='selected'";?>>LUNAS</option>
                            <option value="3" <?php if($data_penjualan[0]['Status'] == 3) echo "selected='selected'";?>>HUTANG</option>
                          </select>
                          </div>
                    </div>
                    ...
                    <div class="form-group hutang">
                          ...
                          <div class="col-sm-6"> 
                            ...
                            <?php if($data_penjualan[0]['Harga_Hutang']!= NULL) echo "value= ".$data_penjualan[0]['Harga_Hutang'];?>
                            >
                          </div>
                    </div>
                   	...
                   	<div class="form-group hutang" id="lbl-tgl-beli"> 
    					...
    					<div class="col-sm-6"> 
    						<input type="text" class="form-control" id="tgl_jth_tmp" name="tgl_jth_tmp" 
                                ...
                                <?php if($data_penjualan[0]['Tgl_Jatuh_Tempo']!= NULL) echo "value= ".$data_penjualan[0]['Tgl_Jatuh_Tempo'];?>
                                >
    					</div><span id='err_nama' class="err_span"></span>
    				</div>
                   ...
                   <table class="table table-bordered table-striped" id="tbl-detail">
                        <thead>
                            <tr>
                                ...
                                <th style = "text-align:center;">Harga Jual Normal </th>
                        ...
                        <tbody id="detail-content">
                            ...
                            foreach($data_penjualan as $row){?>
                                <tr id="item-<?=$i?>">
                                    <td class="td-center" id="kode"><?=$row['Kode_Barang']?></td>
                                    <td id="stock" class="td-center"></td>
                                    <td id="harga" class="td-right">Rp. <?=$row['Harga_Jual_Normal'];?></td>
                                    <td id="qty" class="td-right" ><?=$row['Qty']?></td>
                                    <td id="harga_curr" class="td-right">Rp. <?=$row['Harga_Jual']?></td>
                                    <td id="option" class="td-center">
                                        <button id="edit-<?=$i?>" class="btn btn-primary btn-xs edit-btn" type="button"
                                                data-index-id="<?=$i?>">
                                            <span class="glyphicon glyphicon-pencil"></span>
                                        </button>
                                        <button id="del" class="btn btn-danger btn-xs" type="button" data-index-id="<?=$i?>">
                                            <span class="glyphicon glyphicon-trash"></span>
                                        </button>
                                    </td>
                                    <input type="hidden" id="harga_value" />
                                    <input type="hidden" id="harga_curr_value" />
                                </tr>
                            <?php $i++; } ?>
                        </tbody>
