...
<?php $this->load->view('modal/modal_add_edit_satuan')?>
<script type="text/javascript">
    ...
    $(function() {
        ...
        $("#add-btn").click(function(){
            ...
            $('#created').empty();
            $('#last_modified').empty();
            $('.modal-title').text("Add New Satuan");
            $('#btn-update').hide();
            $('#btn-save').show();
    ...
    <div class="well">
        <div class="row">
            ...
            <div class="col-lg-4" id="search-box">
                <?php echo form_open('satuan/searchSatuan'); ?>
                    ...
                    <tr>
                        ...
                        <td align='center'>
                            <a class="edit-nav" href="#<?php echo $no?>">           
                                <button type="button" class="btn btn-primary btn-xs edit-btn" data-toggle="modal" data-target="#satuan-modal">
                                <span class="glyphicon glyphicon-pencil"></span>&nbsp Edit</button>      
                            </a>    
                           	<a class="btn btn-danger btn-xs " href="<?php echo site_url('satuan/deleteSatuan/'.$row['Satuan_ID'])?>" 
                               onclick="return confirm('Are you sure to delete <?=$row['Satuan_Name']?> ?');">
                                <i class="glyphicon glyphicon-trash"></i>&nbsp Delete
                            </a>
                        </td>
                        
                        <td class="id-item" style="display: none;"><?=$row['Satuan_ID']?></td>
