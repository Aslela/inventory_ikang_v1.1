...
<?php $this->load->view('modal/modal_add_edit_model')?>
...
<div class="content-container" >
    <div class="well">
        <div class="row">
            <div class="col-lg-8">
                <button type="button" class="btn btn-primary btn-xl" id="add-btn" data-toggle="modal" data-target="#model-modal">
                    <span class="glyphicon glyphicon-plus"></span>&nbsp Add Model
                </button>
            </div>
            <div class="col-lg-4" id="search-box">
                <?php echo form_open('modelx/searchModel'); ?>
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td align='center' class="nr"><?=$row['Model_Name']?></td>
                        <td align='center'>
                            <a class="edit-nav" href="#<?php echo $no?>">           
                                <button type="button" class="btn btn-primary btn-xs edit-btn" data-toggle="modal" data-target="#model-modal">
                                <span class="glyphicon glyphicon-pencil"></span>&nbsp Edit</button>      
                            </a>    
                           	<a class="btn btn-danger btn-xs " href="<?php echo site_url('modelx/deleteModelx/'.$row['Model_ID'])?>" 
                               onclick="return confirm('Are you sure to delete <?=$row['Model_Name']?> ?');">
                                <i class="glyphicon glyphicon-trash"></i>&nbsp Delete
                            </a>
                        </td>
                        
                        <td class="id-item" style="display: none;"><?=$row['Model_ID']?></td>
