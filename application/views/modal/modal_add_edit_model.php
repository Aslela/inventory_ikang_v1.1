<!--Modal-->
<div class="modal fade" id="model-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <form id="model-form">
                    ...
                    <div class="form-group">
                        <label for="nama" class="control-label cd-name">Model Name :</label>
                    ...
                    <input type="hidden" id="modul_name" value="Modelx"/>
