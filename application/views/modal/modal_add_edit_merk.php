<!--Modal-->
<div class="modal fade" id="merk-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <form id="merk-form">
                    ...
                    <div class="form-group">
                        <label for="nama" class="control-label cd-name">Merk Name :</label>
                    ...
                    <input type="hidden" id="modul_name" value="Merk"/>
